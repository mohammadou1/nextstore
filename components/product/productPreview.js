...
const ProductSkelton = () => (<Row type="flex">
    ...
    return (
        <Modal width={800}
            ...
            <div className="preview">
                {!product ? <ProductSkelton /> : <Row type="flex">
                    <Col xl={8} lg={8} md={24} sm={24} xs={24}>
                        <Image src="/images/item1.jpg" alt="alt" />
                    </Col>
                    <Col xl={16} lg={16} md={24} sm={24} xs={24}>
                        <div className="preview-details">
                            <Link href={`/items/${product.id}`} as={`/items/${product.slug || product.id}`}>
                                <a>
                            ...
                            <p className="primary-color bold  discounted">
                                $250
                            </p>
                            <p className="primary-color bold mt price">
                                $200
                            </p>

                            <div className="flex controls">
                                <Input type="number" min={0} defaultValue={0} onChange={quantityChangedHandler} />
