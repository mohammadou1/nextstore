...
const services = [
  {
    icon: "fas fa-truck",
    title: "Free Delivery",
    content: "On orders with $100 and more."
  },
  {
    icon: "fas fa-hand-holding-usd",
    title: "Money Back",
    content: "Money back guarantee within 30 days."
  },
  {
    icon: "fas fa-headset",
    title: "24 Hours Support",
    content: "Call us anytime you want."
  },
  {
    icon: "fas fa-gifts",
    title: "Gifts On Payment",
    content: "Earn a gift for each online payment."
  }
];
...
const seo = {
  title: "NextStore",
  meta_keywords:
    "Store,NextStore,NextJS, NextJS Ecommerce,Open Source Ecommerce,ReactJS Ecommerce",
  meta_description: "The best NextJS ECommerce open source project",
  robots: "index,follow"
};

const Index = () => {
  const featuredTitle = <h1>Featured Items</h1>;
  return (
    <Layout>
      <Fragment>
      <Meta
                ...
                <Row type="flex">
                  <NoSSR onSSR={<Loading />}>
                    {services.map((service, idx) => (
                      <Col key={idx} xl={6} lg={6} md={12} sm={12} xs={24}>
                        <div className="service-container">
                          ...
                          <div className="content">
                            <h4>{service.title}</h4>
                            <p className="text">{service.content}</p>
                          </div>
                        </div>
                      </Col>
                    ))}
